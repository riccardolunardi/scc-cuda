...
Esiste una versione precedente a questa, che utilizza al posto del vettore "status", 6 vettori booleani contenente i vari stati di ogni nodo.
Attualmente per poter accedere a tale file è necessario pullare un vecchio commit.
