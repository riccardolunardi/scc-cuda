...
int main(unsigned int argc, char ** argv) {
	...
	printf("Versione 7 - Reach Ottimizzato\n");
	common_routine(routine_v7, profiling, num_nodes, num_edges, nodes, adjacency_list, nodes_transpose, adjacency_list_transpose, status, og_status, repeat);
}