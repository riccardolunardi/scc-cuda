...
int main(unsigned int argc, char ** argv) {
	...
	for(int i=0;i<repeat;i++){
		...
		//routine_v2(profiling, num_nodes_v2, num_edges_v2, nodes_v2, adjacency_list_v2, nodes_transpose_v2, adjacency_list_transpose_v2, og_status);
		routine(profiling, num_nodes, num_edges, nodes, adjacency_list, nodes_transpose, adjacency_list_transpose, og_status);
	}
