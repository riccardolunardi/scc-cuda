...
void trimming_kernel(int num_nodes, int num_edges, int * nodes, int * nodes_transpose, int * adjacency_list, int * adjacency_list_transpose, int * pivots, char * status, bool &stop){
...
void trimming(int num_nodes, int num_edges, int * nodes, int * nodes_transpose, int * adjacency_list, int * adjacency_list_transpose, int * pivots, char * status) {
...
void reach_kernel(int num_nodes, int num_edges, int * nodes, int * adjacency_list, int * pivots, char * status, bool &stop, bool (*get_visited)(char), bool (*get_expanded)(char), void (*set_visited)(char &), void (*set_expanded)(char &)){
...
void reach(int num_nodes, int num_edges, int * nodes, int * adjacency_list, int * pivots, char * status, bool (*get_visited)(char), bool (*get_expanded)(char), void (*set_visited)(char &), void (*set_expanded)(char &)) {
...
void update(int num_nodes, int * pivots, char * status, bool & stop) {
...
void fw_bw(int num_nodes, int num_edges, int * nodes, int * adjacency_list, int * nodes_transpose, int * adjacency_list_transpose, int *& pivots, char * status) {
...
void trim_u_kernel(int num_nodes, int num_edges, int * nodes, int * adjacency_list, int * pivots, char * status, int *& is_scc) {
...
void trim_u(int num_nodes, int num_edges, int * nodes, int * adjacency_list, int *& pivots, char * status, int *& is_scc) {
	...
	trim_u_kernel(num_nodes, num_edges, nodes, adjacency_list, pivots, status, is_scc);
...
int main(int argc, char ** argv) {
	...
	trim_u(num_nodes, num_edges, nodes, adjacency_list, pivots, status, is_scc);
